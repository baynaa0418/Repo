...
import { useRouter } from 'next/navigation';  // Next.js 13+ App Router-д
...
const generateSampleData = (count = 20) => {
  const names = ['Бат', 'Сараа', 'Тэмүүлэн', 'Мөнхзул', 'Хонгор', 'Ганболд'];
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
              ...
              <Box sx={{ display: 'flex', gap: 2 }}>
                ...
                <Button 
                  ...
                  onClick={() => router.push('/vitals/vitalsRegister')}
                >
