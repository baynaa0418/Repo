          ...
          <Grid container spacing={2} justifyContent="center">
            ...
            <Grid item xs={12} sm={4} md={3}>
              <Box
                ...
                sx={{
                  border: type === "student" ? "2px solid primary.main" : "1px solid #ccc",
                  borderRadius: 2,
                  p: 2,
                  textAlign: "center",
                  cursor: "pointer",
              ...
              >
                <SchoolIcon
                  sx={{
                    fontSize: 40,
                    color: type === "student" ? "primary.main" : "inherit",
                  }}
                />
            ...
            <Grid item xs={12} sm={4} md={3}>
              <Box
                ...
                sx={{
                  border: type === "teacher" ? "2px solid primary.main" : "1px solid #ccc",
                  borderRadius: 2,
                  p: 2,
                  textAlign: "center",
                  cursor: "pointer",
              ...
              >
                <MenuBookIcon
                  sx={{
                    fontSize: 40,
                    color: type === "teacher" ? "primary.main" : "inherit",
                  }}
                />
            ...
            <Grid item xs={12} sm={4} md={3}>
              <Box
                ...
                sx={{
                  border: type === "staff" ? "2px solid primary.main" : "1px solid #ccc",
                  borderRadius: 2,
                  p: 2,
                  textAlign: "center",
                  cursor: "pointer",
              ...
              >
                <PeopleIcon
                  sx={{
                    fontSize: 40,
                    color: type === "staff" ? "primary.main" : "inherit",
                  }}
                />
          ...
          <Grid container spacing={2} sx={{ mt: 2 }}>
            ...
            <Grid item xs={6}>
              <Button
                ...
                disabled={!registerNumber || !school || !email}
              >
                Бүртгүүлэх
              </Button>
            </Grid>
